class Texts:
    ...
    def text1(self):
        ...
        Foi com este pensamento que as disciplinas oferecidas pelo Prof. Dr. Flávio Olimpio foram repensadas.
        Este site foi desenvolvido com o objetivo de guiar os alunos nas disciplinas de química ministradas na Instituto Federal de Goiás - Câmpus Uruaçu pelo Prof. Dr. Flávio Olimpio Sanches Neto. 
    ...
    def text2(self):
        ...
        As disciplinas ofericidas no curso e que poderão ser acessados pelos alunos são:<br>        
        (i)  Química Geral I;  <br>
        (ii) Química Geral Experimental. <br>
    ...
    def text3(self):
        ...
        Doutor em Físico-Química (Universidade de Brasília - UnB)<br>
        Pós doutorando em Química (Instituto de Química - Universidade Federal de Goiás)<br>
        Professor IFG - Uruaçu <br>
        flavio_olimpio@outlook.com<br>
