class Texts:
    ...
    def text1(self):
        TEXT1 = """
        <h3 style='text-align: justify; color: black;'> Devido a pandemia ocasionado pelo novo coronavírus (COVID-19), uma reestruturação do ensino teve que ser adotado no Brasil e no mundo para mitigar a transmissão do vírus. 
        ...
        A ideia é que o site se aperfeiçoe com o tempo e com os feedbacks dos alunos.</h3>
        """
